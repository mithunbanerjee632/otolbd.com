              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{ asset('uploads/products') }}/{{ $details->image }}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{ asset('uploads/products') }}/{{ $details->image }}" data-bs-toggle="tooltip"
                  ...
                  @foreach (explode(',',$details->images) as $gimg)
                  <div class="swiper-slide product-single__image-item">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{ asset('uploads/products/thumbnails') }}/{{ $details->image }}" width="104" height="104" alt="{{ $details->name }}" /></div>
                      @foreach (explode(',',$details->images) as $gimg)
                        <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            <span class="current-price">
                ...
                <s>${{$details->regular_price}}</s> ${{ $details->sale_price }}
          ...
          @if (Cart::instance('cart')->content()->where('id',$details->id)->count()>0)
          ...
          <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
            ...
            <div class="product-single__addtocart">
              ...
              <input type="hidden" name="price" value="{{ $details->sale_price == '' ? $details->regular_price:$details->sale_price   }}"/>
          ...
          <div class="product-single__meta-info">
            ...
            <div class="meta-item">
              ...
              <span>{{$details->categories->name}}</span>
            </div>
            <div class="meta-item">
              <label>Tags:</label>
              <span>N/A</span>
            ...
            <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="{{ route('shop.product.details',['product_slug'=>$rproduct->slug]) }}">
                    ...
                    @foreach (explode(',',$rproduct->imaages) as $rgimg)
